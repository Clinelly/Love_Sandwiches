...
def get_sales_data():
    ...
    via the terminal, which must be a string of numbers seperated by
    a comma. The loop will repeatedly request data until it is valid.
    """
    while True:
...
#Code commented out with docstring.
#Code is obsolete due to refactoring in the update_worksheet function.
#Code has been kept for reference and refactoring reminders.
    """
